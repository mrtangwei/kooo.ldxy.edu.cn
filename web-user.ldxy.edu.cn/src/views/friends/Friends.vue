<template>
    ...
    <section>
        ...
        <el-table :data="dataSet" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="dauNew" label="新增人数" width="160" sortable>
            </el-table-column>
            <el-table-column prop="number" label="拥有好友人数" width="180" sortable>
            </el-table-column>
            <el-table-column prop="numberRate" label="拥有好友占比" :formatter="doubleFilter"  width="180" sortable>
            </el-table-column>
            <el-table-column prop="numberNew" label="新增拥有好友人数" width="200" sortable>
            </el-table-column>
            <el-table-column prop="numberNewRate" label="新增拥有好友占比" :formatter="doubleFilter" width="200" sortable>
            </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            querySubmit: function (type) {
                ...
                var url = '/api/security/friends/group/' + this.serverId + '/' + this.rangeDate[0] + '/' + this.rangeDate[1]  + '/';
