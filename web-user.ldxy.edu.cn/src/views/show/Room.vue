<template>
    <section>
        ...
        <el-table :data="dataSet" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="uidCount" label="参与排练室人数" width="180" sortable>
            </el-table-column>
            <el-table-column prop="uidTimes" label="参与排练室次数" width="180" sortable>
            </el-table-column>
            <el-table-column prop="rate" label="参与占比率" width="180" :formatter="doubleFilter" sortable>
            </el-table-column>
            <el-table-column prop="ave" label="平均参与次数" width="180" :formatter="intFilter" sortable>
            </el-table-column>
            <el-table-column prop="uidCountNew" label="当日新增参与排练室人数" width="180" sortable>
            </el-table-column>
            <el-table-column prop="uidTimesNew" label="当日新增参与排练室次数" width="180" sortable>
            </el-table-column>
            <el-table-column prop="rateNew" label="新增参与率" width="180" :formatter="doubleFilter" sortable>
            </el-table-column>
            <el-table-column prop="aveNew" label="新增平均参与次数" width="180" :formatter="intFilter" sortable>
            </el-table-column>
            <el-table-column>
            </el-table-column>
        </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            querySubmit: function () {
                ...
                var url = '/api/security/room/group/' + this.serverId + '/' + this.rangeDate[0] + '/' + this.rangeDate[1];
