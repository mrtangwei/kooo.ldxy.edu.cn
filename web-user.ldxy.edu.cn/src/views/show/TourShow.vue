<template>
    <section>
        ...
        <el-table :data="dataSet" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="uidCount" label="参与巡演人数" width="180" sortable>
            </el-table-column>
            <el-table-column prop="uidTimes" label="参与巡演次数" width="180" sortable>
            </el-table-column>
            ...
            <el-table-column prop="uidCountNew" label="当日新增参与巡演人数" width="180" sortable>
            </el-table-column>
            <el-table-column prop="uidTimesNew" label="当日新增参与巡演次数" width="180" sortable>
            </el-table-column>
     ...
     data() {
        ...
        methods: {
            ...
            querySubmit: function () {
                ...
                var url = '/api/security/tourShow/group/' + this.serverId + '/' + this.rangeDate[0] + '/' + this.rangeDate[1];
